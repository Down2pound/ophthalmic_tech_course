export function renderFirstSaleSupportRunbook({
  ...
  return [
    ...
    "- Use `GET /api/support/buyer-lookup?email=buyer@example.com` with the private admin token to check app-side purchases, enrollments, practice packs, and practice-seat assignments.",
    ...
    "5. Confirm the buyer email is present on the checkout session or customer details.",
    "6. Retry the Stripe webhook only after the database and readiness checks are healthy.",
    "",
    ...
    "3. Ask the learner to request a fresh sign-in link.",
    ...
    "4. Record the Stripe refund ID and date in safe notes.",
    "5. If access should be removed after refund, confirm the exact learner or practice account first.",
    "",
