export function renderFirstSaleSupportRunbook({
  ...
  return [
    ...
    "4. Confirm the buyer email is present on the checkout session or customer details.",
    "5. Retry the Stripe webhook only after the database and readiness checks are healthy.",
    "",
    "## Learner Cannot Sign In",
    "",
    "1. Confirm the learner is using the same email that received access.",
    "2. Ask the learner to request a fresh sign-in link.",
    "3. Confirm transactional email settings are configured in `/api/launch/readiness`.",
    "4. Check spam or quarantine before changing the learner record.",
    "5. Never forward or paste a magic-link token into support notes.",
    "",
    "## Practice Seat Problem",
    "",
    "1. Confirm the practice pack size purchased.",
    "2. Confirm the manager is using the correct buyer or admin email.",
    "3. Confirm the requested learner email is typed correctly.",
    "4. Check whether the seat pack is already full.",
    "5. If a seat was assigned to the wrong email, document the request before changing access.",
    "",
