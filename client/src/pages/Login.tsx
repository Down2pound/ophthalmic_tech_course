      ...
      <div className="px-4 py-16">
        <Card className="mx-auto w-full max-w-md bg-white p-8 shadow-2xl">
          ...
          <form onSubmit={submit} className="space-y-5">
            ...
            <div>
              <div className="mb-2 flex items-center justify-between">
                ...
                <a href="/forgot-password" className="text-sm font-semibold text-blue-600 hover:underline">Forgot password?</a>
              </div>
          ...
          <div className="mt-6 space-y-2 text-center text-sm text-slate-500">
            <p>Paid but never activated? <a href="/support" className="font-semibold text-blue-600 hover:underline">Contact support</a>.</p>
