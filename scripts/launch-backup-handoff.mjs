...
const report = [
  ...
  "",
  "Beginner restore rule: use GitHub first when this branch is pushed. Use Google Drive only when GitHub is blocked or missing the branch.",
  "",
  "If this report says the current commit's portable ZIPs are missing, check the backup manifest before worrying. A newer commit may only update backup notes, while the manifest points to the latest confirmed full source backup set.",
  "",
  ...
  "```",
  "",
  "On a locked-down work computer, run the smaller safe check with:",
  "",
  "```bash",
  ...
  "```",
  "",
  "Confirm public offer prices, checkout prices, and Stripe setup notes still match with:",
  "",
  "```bash",
  "pnpm launch:offer-audit",
  "```",
  "",
  "Confirm Render, Docker, Procfile, and CI launch settings still match with:",
  "",
  "```bash",
  "pnpm launch:deployment-audit",
  "```",
  ...
  "## First Sales Links",
  "",
  "Print the shortest safe path from restored code to one controlled paid buyer with:",
  "",
  "```bash",
  ...
  "```",
  "",
  "Print a read-only owner traffic-light report for preview, practice inquiry, and paid checkout links with:",
  "",
  "```bash",
  ...
  "",
  "Print the latest unmapped Bootcamp Drive intake queue with:",
  "",
  "```bash",
