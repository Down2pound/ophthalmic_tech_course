...
const lines = [
  ...
  "- Approval receipt after review: run `pnpm launch:clinical-signoff`",
  "",
  ...
  "Run `pnpm launch:clinical-signoff` after approval to save the safe signoff packet before changing production values.",
  "",
