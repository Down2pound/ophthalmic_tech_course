...
const lines = [
  ...
  '$env:LAUNCH_MANUAL_FULFILLMENT_REPORT_PATH="launch-evidence/manual-fulfillment-packet.md"',
  "pnpm launch:manual-fulfillment -- --email=buyer@example.com --offer=founding-learner --payment-reference=pi_or_payment_link_reference",
  ...
  '$env:LAUNCH_FIRST_BUYER_FEEDBACK_REPORT_PATH="launch-evidence/first-buyer-feedback-packet.md"',
  "pnpm launch:first-buyer-feedback -- --buyer-type=individual --email=buyer@example.com --offer=founding-learner",
  "```",
  "",
  "## Bash Commands",
  "",
  ...
  `LAUNCH_BASE_URL=${baseUrl} LAUNCH_MANUAL_FULFILLMENT_REPORT_PATH=launch-evidence/manual-fulfillment-packet.md pnpm launch:manual-fulfillment -- --email=buyer@example.com --offer=founding-learner --payment-reference=pi_or_payment_link_reference`,
  ...
  `LAUNCH_FIRST_BUYER_FEEDBACK_REPORT_PATH=launch-evidence/first-buyer-feedback-packet.md pnpm launch:first-buyer-feedback ${baseUrl} -- --buyer-type=individual --email=buyer@example.com --offer=founding-learner`,
  "```",
  "",
