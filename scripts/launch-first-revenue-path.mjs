...
const lines = [
  ...
  "",
  "- Latest confirmed backup label: `2026-07-24`.",
  "- Latest confirmed backup commit: `433a358`.",
  "- Latest source ZIP: `optitech-academy-source-2026-07-24-433a358.zip`.",
  "- Latest Git bundle: `optitech-academy-branch-2026-07-24-433a358.bundle`.",
  "- GitHub branch: `codex/optitech-product-spec`.",
  "- Use GitHub first. Use the Drive ZIP or bundle only if GitHub is blocked.",
  "",
  "```bash",
